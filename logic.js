...
// Decalare variables for the touch input
let startX = 0;
let startY = 0;
...
//This will check for where you touch yourr screen and prevents scroling if you touch input target any elemt that includes the word tile in their class name.
...
// Eevent listener that will listen to the touch end

document.addEventListener('touchend', (e)=> {
	// check if the elemt that triggered the event has a class name containg tile
	if(!e.target.className.includes("tile")){
		return;
	}
